...
### ✏️ Exercise 2: Create your own `config.ini` and `config.py` 
...
and add the secrets for both databases, then you will have to create the `config.py` file to pull your secrets from there 
